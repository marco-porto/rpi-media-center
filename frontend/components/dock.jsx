...
export default function Dock() {
  ...
  if (!hide)
    return (
      <div
        className="absolute flex flex-col items-center w-20 p-2 mx-8 text-white bg-opacity-25 rounded-full h-44 bg-dockPurple top-20"
        onMouseEnter={() => {
          setHide(false);
        }}
        onMouseLeave={() => {
      ...
      >
        <div className="m-2">
          <div className="p-6">
            <button onClick={() => {handleShutdown();play();}}>
              <svg
                width="20"
                height="20"
                viewBox="0 0 15 16"
          ...
          <div className="p-6">
            <button onClick={() => {handleMinimize();play();}}>
              <svg
                width="20"
                height="20"
                viewBox="0 0 15 15"
    ...
    return (
      <div
        className="absolute flex flex-col items-center w-20 p-2 mx-8 text-white bg-opacity-0 rounded-full h-44 bg-dockPurple top-20"
        onMouseEnter={() => {
          setHide(false);
        }}
        onMouseLeave={() => {
