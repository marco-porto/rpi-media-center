export default function Dock(props) {
  console.log(props);
  let hideClass = props.hidden != undefined && props.hidden ? "hidden" : "";
  return (
    <div
      className={
        "absolute flex flex-col items-center w-20 p-2 mx-8 text-white bg-opacity-25 rounded-full h-44 bg-dockPurple top-20" +
        hideClass
      }
    >
      <div className="m-2">
